---
titulo: "Qué ver en Girona en un día: casco medieval y Juego de Tronos"
...
1. **Cruzar el casco antiguo en diez minutos.** Merece pararse: cada calle tiene historia.
2. **Venir solo a por las fotos de Juego de Tronos.** La ciudad es mucho más que un set de rodaje.
3. **Saltarte la muralla.** Es el mejor mirador y casi nadie sube.
4. **Entrar en coche al casco.** Es peatonal y de cuestas; déjalo en un parking de borde.

## Errores típicos del visitante

> **⚠️ Aviso:** los fallos que más vemos.

1. **Tratar Girona como media hora de parada.** Cabe en un día completo, no en un café entre Barcelona y la Costa Brava.
2. **No subir a la catedral por dentro.** La nave y el Tapiz de la Creación justifican la entrada.
3. **Comer en la primera terraza de la Rambla.** Camina una calle y mejora.
4. **Irse antes del atardecer.** La luz dorada sobre el Oñar y la muralla es lo mejor del día.
