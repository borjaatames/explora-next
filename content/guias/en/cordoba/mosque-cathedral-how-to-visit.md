---
titulo: "Mosque-Cathedral of Córdoba: how to visit it (tickets and tips)"
descripcion: "How to visit the Mosque-Cathedral of Córdoba: tickets and the free morning slot, what to see (forest of columns, mihrab, Courtyard of the Orange Trees), the tower and best tips."
categoria: "cordoba"
...
keywords:
  ...
  - "how to visit the mosque of cordoba"
  - "cordoba mihrab"
...
Allow **1h-1h 30min**. A **guided tour** helps you understand why there are two temples in one (priority entry also saves the queue). Dress respectfully: it's a working cathedral. We slot it in as the first stop of the day in [Córdoba in one day](/en/guides/cordoba/cordoba-in-one-day).

## What we don't recommend

1. **Going at midday in summer.** Queues and heat; go first thing.
2. **Not booking in high season.** The box-office queue can be long.
3. **Visiting in a rush.** The mihrab and the contrast of the two temples deserve calm.
4. **Skipping the tower.** The views of the old town and the orange courtyard are worth it.

## Common mistakes

> **⚠️ Warning:** the slip-ups we see most.

1. **Not checking the free morning slot** if it fits your plans.
2. **Going on a Sunday morning** without knowing that worship limits the visit.
3. **Underestimating the time.** Many people go in rushed and miss the mihrab.

## In one sentence

The Mosque-Cathedral is visited first thing, unhurried and, if you can, in the free slot: the forest of columns, the gilded mihrab and the embedded cathedral are one of the great monumental experiences in Europe. It's the heart of [Córdoba in one day](/en/guides/cordoba/cordoba-in-one-day).
