...
ciudad: "madrid"
descripcion: "Visita privada al Prado solo para tu grupo, con guía historiador del arte y recogida en tu hotel en taxi. Dos horas dentro del museo a tu ritmo, centradas en lo que más te interesa."
...
highlights:
  - "Solo tu grupo, sin desconocidos"
  - "Recogida en hotel incluida (taxi al museo)"
  - "Guía historiador del arte titulado"
  - "Cancelación gratuita hasta 24h antes"

incluye:
  - "Guía privado titulado en historia del arte"
  - "Entrada sin colas al museo"
  - "Recogida en tu hotel en taxi"
noIncluye:
  - "Comida y bebida"
  - "Propinas"

puntoEncuentro:
  texto: "El guía te recoge directamente en el lobby de tu hotel a la hora acordada."
  descripcionGuia: "El guía se identificará por tu nombre en recepción. El traslado al Prado se hace en taxi (incluido)."
  latitud: 40.4138
  longitud: -3.6921
  zoom: 17
...
informacionImportante:
  queTraer:
    ...
    - "Calzado cómodo"
  noAptoPara:
    - "Mochilas mayores de 40×40 cm en el museo"
  aTenerEnCuenta:
    - "El precio es POR PERSONA. Para grupos de 3+ personas, el coste por cabeza baja"
    - "El menor de 18 años debe ir acompañado de un adulto"
    - "Disponible en español, inglés y francés (indícalo al reservar)"
