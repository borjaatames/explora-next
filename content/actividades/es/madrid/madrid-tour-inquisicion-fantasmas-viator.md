---
titulo: "Madrid Nocturno: Tour de la Inquisición y Fantasmas (Viator)"
slug: "madrid-tour-inquisicion-fantasmas-viator"
ciudad: "madrid"
descripcion: "Tour nocturno a pie por el Madrid oscuro: historias de la Inquisición Española y leyendas urbanas con guía narrador. Reservado en Viator."
...
idiomas: ["es", "en"]
proveedor: "viator"
urlReserva: "https://www.viator.com/tours/Madrid/Spanish-Inquisition-Tour-and-Ghost-Stories-of-Madrid/d566-135793P1?pid=P00298823&mcid=42383&medium=link"
cancelacionGratuita: true
horasCancelacion: 24

highlights:
  - "Tour a pie nocturno por el Madrid oscuro"
  - "Historias de la Inquisición Española, fantasmas y leyendas urbanas"
  - "Guía narrador con vestuario de época en algunos operadores"
  - "Reserva en Viator"

incluye:
  - "Guía narrador"
  - "Tour a pie de 2 horas"
...
puntoEncuentro:
  texto: "Confirma el punto de encuentro exacto en email de reserva — habitualmente en una plaza del centro histórico (Plaza Mayor, Plaza Provincia, Sol o similar)."
  descripcionGuia: "Metro Sol (líneas 1/2/3) a 5 minutos de los puntos más comunes. Llega 10 minutos antes. Lleva calzado cómodo y paraguas o capa de lluvia si la previsión es regular."
  latitud: 40.4148
  longitud: -3.7061
  zoom: 18
...
informacionImportante:
  queTraer:
    - "Calzado cómodo (2 h andando)"
    - "Paraguas o capa de lluvia"
...
preguntasFrecuentes:
  ...
  - pregunta: "¿Es histórico o anecdótico?"
    respuesta: "Mezcla. Hay base real sobre la Inquisición Española (siglos XV-XIX) y el Madrid moderno temprano, mezclada con leyendas urbanas. No es académico riguroso pero tampoco invención pura."
...
Tour nocturno a pie de 2 horas por el casco antiguo de Madrid. Relato dramatizado sobre la Inquisición Española, fantasmas y leyendas urbanas del Madrid moderno temprano.

- **Inquisición Española:** historias de persecución, tortura y ejecuciones.
- **Fantasmas y leyendas urbanas** del casco antiguo.
- **Supersticiones populares** del Madrid pre-moderno.
- **Rincones oscuros** que en visita diurna pasan desapercibidos.

## Cómo funciona

**Punto de encuentro:** confirmar en email (centro histórico). **Llega 10 minutos antes.**

**Duración: 2 horas.** Idiomas: español e inglés.

**Si llueve:** el tour se hace igual. Lleva paraguas o capa.

**Apto desde 8 años.** Niños menores pueden asustarse con los temas.

## A quién se lo recomiendo

- A viajeros que quieren plan nocturno entretenido y barato.
- A parejas o grupos pequeños que disfruten formato relato.
- A familias con niños desde 8 años.
- A usuarios habituales de Viator.

## A quién NO se lo recomiendo

- A viajeros con movilidad reducida (adoquinado complicado).
- A académicos exigentes con rigor histórico.
- A niños muy pequeños (temas oscuros).
- A quien valore validación social masiva: el equivalente GetYourGuide tiene 1.482 reseñas.
