---
titulo: "Madrid: Cata de Jamón Ibérico, Embutidos, Quesos y Vino (Viator)"
slug: "iberian-ham-wine-tasting-viator"
ciudad: "madrid"
descripcion: "Cata guiada de jamón ibérico, embutidos curados, quesos españoles y vinos en Madrid. Reservada en Viator. Experiencia gastronómica con explicación de productos D.O. e historia."
...
highlights:
  - "Cata guiada de jamón ibérico, embutidos curados y quesos D.O. españoles"
  - "Maridaje con vinos seleccionados (Rioja, Ribera del Duero, etc.)"
  - "Explicación de denominaciones de origen y proceso de curación"
  - "Producto Viator pensado para foodies"

incluye:
  - "Cata de jamón ibérico (varias variedades)"
  - "Cata de embutidos curados (chorizo, lomo, salchichón)"
  - "Cata de quesos españoles D.O."
  - "Maridaje con varios vinos"
  - "Guía gastronómico con explicación"

noIncluye:
  - "Comida completa (es cata, no menú)"
  - "Bebidas extra fuera de las del maridaje"
  - "Propinas"
  - "Transporte"

puntoEncuentro:
  texto: "Confirma la dirección exacta en email de reserva — habitualmente en una tienda gourmet, bodega o espacio de cata del centro de Madrid."
  descripcionGuia: "El punto suele estar en el casco antiguo o La Latina. Llega 10 minutos antes. Si tienes restricciones alimentarias o alergias, avisa al operador antes."
  latitud: 40.4147
  longitud: -3.7080
  zoom: 16
...
informacionImportante:
  queTraer:
    - "Documento de identidad (puede pedirse — hay vino)"
    - "Apetito moderado — es cata, no comida completa"
  noAptoPara:
    - "Menores de edad (hay vino)"
    - "Vegetarianos/veganos (la cata es de carne y queso)"
...
preguntasFrecuentes:
  - pregunta: "¿Qué jamones se catan?"
    respuesta: "Habitualmente varias categorías: jamón ibérico de cebo, ibérico de cebo de campo y, en algunos operadores, ibérico de bellota (el premium). La explicación cubre las denominaciones (Jamón de Guijuelo, Jamón de Jabugo, Jamón de Los Pedroches) y cómo distinguir calidades."
  - pregunta: "¿Qué vinos?"
    respuesta: "Selección típica: tinto Rioja, tinto Ribera del Duero, y a veces un blanco español (Verdejo, Albariño) o un fino de Jerez. El maridaje se explica con cada plato."
  - pregunta: "¿Es comida completa?"
    respuesta: "No. Es CATA — degustaciones de cada producto, no raciones. Si vas con hambre completa, sal antes a tapear ligero o reserva mesa después en un bar."
...
- **Embutidos curados:** chorizo, lomo, salchichón.
- **Quesos D.O. españoles:** Manchego, Cabrales, Idiazábal, etc.
- **Maridaje con vinos:** Rioja, Ribera del Duero, eventualmente blanco o fino de Jerez.
...
- A foodies que quieran entender productos D.O. españoles.
- A amantes del jamón ibérico con curiosidad por categorías.
- A parejas con plan gastronómico de tarde-noche.
- A usuarios habituales de Viator.

## A quién NO se lo recomiendo

- A vegetarianos y veganos (pierden la mayor parte).
- A personas con alergias múltiples sin confirmar antes.
- A viajeros que esperen comida saciante (esto es cata).
- A menores de edad (hay vino).
