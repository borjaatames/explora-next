...
- src: /images/actividades/barcelona/sagrada-familia/pexels-33053352-hero.webp
  alt: Low-angle view of the Sagrada Família's exterior towers.
...
- If you don't want to risk a bilingual group: see the [express tour](/en/cities/barcelona/activities/sagrada-familia-express-guided-tour), which is run only in the language you choose.
- If the score matters to you: the [skip-the-line guided tour](/en/cities/barcelona/activities/sagrada-familia-skip-the-line-guided-tour) is better rated for a similar price.
