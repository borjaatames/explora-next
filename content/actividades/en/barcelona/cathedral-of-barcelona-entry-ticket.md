---
titulo: "Barcelona Cathedral: Entry Ticket (Cultural Visit, Self-Guided)"
slug: "cathedral-of-barcelona-entry-ticket"
ciudad: "barcelona"
descripcion: "Self-guided entry ticket to Barcelona Cathedral (Santa Esglèsia Catedral Basílica Metropolitana). 1,916 reviews at 4.5/5. The basic, highest-volume product — pre-booked online, mobile voucher."

slugs:
  es: "catedral-de-barcelona-entrada"
  en: "cathedral-of-barcelona-entry-ticket"

duracion: "1 - 2 hours (self-paced)"
duracionMinutos: 90
precioDesde: 21
moneda: "EUR"
idiomas: ["es", "en"]
proveedor: "getyourguide"
urlReserva: "https://www.getyourguide.com/barcelona-l45/barcelona-cathedral-of-barcelona-entry-ticket-t428189/?partner_id=VPFQWBY&utm_medium=online_publisher&placement=content-middle"
...
puntoEncuentro:
  texto: "Barcelona Cathedral, Pla de la Seu s/n, 08002 Barcelona. Main entrance is the Porta Principal on Pla de la Seu. Wheelchair-friendly entrance is the Porta de Santa Eulàlia (Carrer del Bisbe). Show your mobile voucher to the staff at the entrance."
  descripcionGuia: "Located in the heart of the Barri Gòtic (Gothic Quarter). Metro: Jaume I (L4, 3 min walk) or Liceu (L3, 7 min walk). Bus: 17, 19, 40, 45 nearby. From Plaça de Catalunya it's a 10-12 min walk down La Rambla, then left into Carrer de la Portaferrissa. The square in front (Pla de la Seu) is pedestrian — easy to find. NOTE: this is the medieval Gothic cathedral of Barcelona — NOT the Sagrada Família (those are different buildings; many travelers mix them up)."
  latitud: 41.3839
  longitud: 2.1761
  zoom: 17
...
accesibilidad: "Wheelchair access available via Porta de Santa Eulàlia (Carrer del Bisbe). The main entrance (Pla de la Seu) has steps. Once inside, the ground level of the cathedral is mostly accessible; the cloister has cobblestones. Crypt of Santa Eulalia is reached by a short staircase (not wheelchair accessible). Assistance dogs allowed; other pets not."

politicaCancelacion: "NON-refundable. Once booked, the ticket cannot be cancelled, refunded or rescheduled. If you need flexibility, choose t949030 (Private Tour with Rooftop) which offers free cancellation up to 24 hours before the visit."

preguntasFrecuentes:
  - pregunta: "Is the Barcelona Cathedral the same as the Sagrada Família?"
    respuesta: "NO — these are two different buildings, often confused. The Barcelona Cathedral (Catedral de Barcelona, Santa Esglèsia Catedral Basílica Metropolitana) is the medieval GOTHIC cathedral, built between the 13th and 15th centuries, located in the Barri Gòtic. The Sagrada Família is Antoni Gaudí's modernist temple, started in 1882 and still under construction, located in the Eixample district about 2 km north. Both are worth visiting, but they are completely separate experiences. This ticket is for the Gothic cathedral only."
  - pregunta: "Does this ticket include rooftop / terraces access?"
    respuesta: "NO — the terraces (rooftop) are sold separately by the Cathedral and typically cost an additional €5-8. If rooftop access matters to you, consider t949030 (Private Cathedral Tour with Rooftop Access, ~€32) which bundles both, or t638978 (Cathedral Guided Tour + VR Experience, ~€32) which includes the rooftop with a VR overlay over the city views."
  - pregunta: "When can I visit?"
    respuesta: "Cultural and tourist visiting hours are typically 14:00-17:00 (last access 16:30) on weekdays, with adjusted Saturday and Sunday hours due to religious services. Outside of these tourist hours, the Cathedral remains open for free religious visit (you can enter and pray, but not tour as a tourist with a paid ticket). Always check current hours on `catedralbcn.org/es/visita-turistica/horarios-visita-turistica/` before booking — religious holidays can close the tourist visit entirely."
  - pregunta: "Should I book online or buy at the door?"
    respuesta: "Booking online with this ticket has two practical benefits: (1) you skip the ticket office queue (which can have 10-30 min waits in high season May-September); (2) you lock in your slot for the date you want. The downside: it's non-refundable, so book only if you're sure of your date. If your trip is fluid, buying at the door for €16 cash works fine in low season (Nov-March)."

variantes: ["cathedral-of-barcelona-private-tour-with-rooftop", "cathedral-of-barcelona-guided-tour-with-vr-experience"]

opinionEditorial: |
  The basic, highest-volume Barcelona Cathedral product on GetYourGuide — 1,916 reviews at 4.5/5, sold by GetYourGuide Tours & Tickets GmbH as a self-guided entry ticket. The recurring positive sentiment focuses on the Gothic architecture's silent grandeur ("massive and stunning, especially the cloister with the geese"), the central Barri Gòtic location (5-10 min walk from anywhere in the Gothic Quarter), and the value-for-money rating (4.3/5 — one of the better ratios in Barcelona's monument space). The recurring complaint is the limited cultural visit window (only ~14:00-17:00 most days), which surprises travelers expecting all-day access — read the listing carefully.
...
galeria:
  - src: "/images/actividades/barcelona/catedral/catedral-hero.webp"
    alt: "Gothic facade of Barcelona Cathedral in the Barri Gotic"
