...
ciudad: "barcelona"
descripcion: "Live 50-55 minute flamenco show at Palau Dalmases, a 17th-century Baroque palace on Carrer Montcada (El Born, next to Picasso Museum). 919 reviews at 4.6/5. VIP / Zone A (with drink included) / Zone B options. Access to the palace art gallery included. 4 daily sessions: 5:30, 6:45, 8 and 9:15 PM."
...
puntoEncuentro:
  texto: "Present your voucher at the Palau Dalmases entrance, Carrer Montcada 20 (08003 Barcelona, El Born neighbourhood). The palace is 100 metres from the Picasso Museum and the Santa Maria del Mar church — pedestrian area, easy to find."
  descripcionGuia: "Metro: Jaume I (L4, 4 min walk) or Barceloneta (L4, 8 min walk). Bus: V15, V17 (Pla de Palau stop). El Born is a pedestrian area — don't arrive by car (no parking; the closest public car parks are 10-15 min walk, NIT Marqués de l'Argentera or NIT Glòries). Arrive 15-20 min early — the palace has limited capacity and seats are assigned within each zone in arrival order (first come, first choice within the booked zone). If you want a specific aisle or corner seat, arrive early."
  latitud: 41.3848
  longitud: 2.1819
  zoom: 17
...
accesibilidad: "Wheelchair accessible — the palace has level access from Carrer Montcada and an adapted toilet. Carrer Montcada is a pedestrian area with medieval cobblestones (typical of El Born) — the chair may vibrate; if mobility is very reduced, consider an adapted taxi to the door. Flat seating, no tiered raising — short people or children may have partially blocked views (booster available at the entrance)."

politicaCancelacion: "FREE cancellation up to 24 hours before the start time — full refund. Within 24 hours: no refunds. The show goes ahead with the palace open to the public — not cancelled for low attendance. Date changes subject to availability."

preguntasFrecuentes:
  - pregunta: "What are the differences between VIP Zone, A and B?"
    respuesta: "**VIP Zone (€50 adult / €20 child):** front rows of the palace, close to the stage; drink included (wine, cava, sangria, beer or soft drink). Optimal view and acoustics. **Zone A (€40 adult / €15 child):** middle rows of the palace; drink included. Good view and excellent acoustics. **Zone B (€30 adult / €15 child):** back rows of the palace; drink NOT included (purchase separately at the bar, ~€5). Correct view of the stage, palace acoustics still good. **Recommendation:** Zone A is the best value (middle rows + drink). VIP Zone if you want a premium experience. Zone B if budget is tight or you want children without paying for adult drinks."
  - pregunta: "Can I dine before or after the show at Palau Dalmases itself?"
    respuesta: "YES. Optional add-ons at booking: **TAPAS MENU €18** (selection of cold meats and cheeses, Spanish tortilla, olives, bread with tomato; vegetarian option with cheeses, tortilla, gazpacho, salad) · **SPANISH DINNER €35** (traditional dinner, vegetarian option available). Dinner is served in the medieval courtyard or art gallery BEFORE or AFTER the show — not during. If you want dinner DURING the show, look for **Tablao de Carmen** (the only such format in Barcelona)."
  - pregunta: "What's the history of Palau Dalmases?"
    respuesta: "The **Palau Dalmases** is a Baroque palace built in the 17th century on Carrer Montcada — the oldest and noblest street in El Born, where the medieval merchant aristocracy palaces stood. The facade is from the 15th century (Catalan Gothic), reformed in the 17th in Baroque style with the monumental staircase and the Abduction of Europa reliefs in the main hall. Today part of the building houses **Òmnium Cultural** (institution defending Catalan language and culture), and the flamenco show hall in another part. The building has been restored preserving the original character without losing modernity — the combination of Baroque palace + flamenco creates a visually unique experience."
  - pregunta: "What's the difference with Tablao Cordobés and Tablao de Carmen?"
    respuesta: "**Palau Dalmases (this):** 17th-century Baroque palace in El Born, SHORT 50 min format (no mandatory dinner), 4 daily sessions — the most flexible to combine with dinner at El Born restaurants. From €30, architecturally spectacular palace. **Tablao Cordobés:** Historic tablao on Las Ramblas, 1h 20min show without microphones, Nasrid décor, optional dinner BEFORE the show. From €48. **Tablao de Carmen:** Inside Poble Espanyol (Montjuïc), THE ONLY ONE with dinner during show, long format (2-3h with dinner), highest rated 4.8/5. From €88. **Choose Palau Dalmases if:** you want a spectacular venue + short format + affordable price + freedom to dine at El Born restaurants. **DO NOT choose Palau Dalmases if:** you want dinner included (Tablao de Carmen) or a historic tablao without microphones (Cordobés)."
  - pregunta: "How do I combine the show with the Picasso Museum?"
    respuesta: "The **Palau Dalmases is 100 metres from the Picasso Museum** (Carrer Montcada — the same street). Ideal combination: visit the Picasso Museum in the afternoon (closes 7 PM Mon-Thu, 8 PM Fri-Sat; see our `picasso-museum-skip-the-line-guided-tour` page), quick dinner in El Born (Cal Pep, Bar del Pla, Bormuth) and Palau Dalmases show at the 8 PM or 9:15 PM session. Tourist cards: if you have Articket Barcelona or Bcn Card, it covers the Picasso Museum. Palau Dalmases is NOT included in tourist passes — book separately."
...
variantes:
  ...
  - nombre: "VIP"
    ...
    precio: 50
  - nombre: "Tapas Add-on"
    descripcion: "Tapas menu served in the medieval courtyard or art gallery (before or after the show). €18 extra over chosen zone."
    precio: 18
  - nombre: "Spanish Dinner Add-on"
    descripcion: "Traditional Spanish dinner served in the medieval courtyard or art gallery. Vegetarian option available. €35 extra over chosen zone."
    precio: 35
...
opinionEditorial: |
  ...
  **Price comparison:** from €30 it's the most affordable of the 4 top tablaos — equivalent to Zone B without drink. Zone A (€40 with drink) is the best value: middle rows + drink included costs the same as Cordobés show-only (€48 with drink) but in a more spectacular venue. The VIP (€50) is equivalent to a light dinner at Cordobés (Tapas + Show, €69) — more expensive but with much less food. If you compare equivalent zones, Palau Dalmases comes out as a good mid-to-high option.
  ...
  Two operational notes: **(1)** seats are flat (no theater tiering) — if going with children or you're short and book Zone B, consider asking for a booster at the entrance or moving up to Zone A. **(2)** The palace is in a pedestrian area with medieval cobblestones — comfortable shoes recommended, and don't arrive by car (no parking nearby).
...
imagenAlt: "Flamenco show at the 17th-century Baroque Palau Dalmases palace in El Born Barcelona"

galeria:
  - src: "/images/actividades/barcelona/flamenco/flamenco-hero.webp"
    alt: "Palau Dalmases — live flamenco in a 17th-century Baroque palace on Carrer Montcada"
