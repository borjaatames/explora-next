...
slug: sagrada-familia-guided-tour-with-free-time
ciudad: barcelona
descripcion: A 1.5-hour small-group guided tour of the Sagrada Familia, with skip-the-line entry and free time inside the
  basilica and the museum afterwards.
slugs:
  en: sagrada-familia-guided-tour-with-free-time
  es: sagrada-familia-tour-guiado-tiempo-libre
duracion: 1h 30min + free time
duracionMinutos: 90
precioDesde: 59
moneda: EUR
idiomas:
...
urlReserva: https://www.getyourguide.com/barcelona-l45/barcelona-tour-de-la-sagrada-familia-con-ticket-de-entrada-sin-colas-t355905/?partner_id=C71NOAW
...
- Food and drink
puntoEncuentro:
  texto: Vivari café, next to the Sagrada Familia, 08025 Barcelona
  descripcionGuia: 'Arrive 15 minutes early at the Vivari café, next to the basilica. A representative will be there with
    a «The Tour Guy» sign. Bring the ID of every participant, including children: without it, entry is denied.'
  latitud: 41.405
  longitud: 2.1755
  zoom: 17
detallesPracticos:
...
informacionImportante:
  ...
  aTenerEnCuenta:
  - Some areas of the basilica may close for religious events; if that happens, the operator makes up for it with another
    gallery or space
  - 'Church dress code: no short trousers, sleeveless tops or large suitcases or bags'
  - Some travellers note the guided part can run slightly shorter than advertised; the free time afterwards makes up for the
    route
accesibilidad: The operator expressly states this route is NOT recommended for people with reduced mobility or wheelchair
  users. If you need accessibility, choose the small-group guided tour, which does declare it.
...
- pregunta: How is it different from the other guided tours?
  respuesta: In that it doesn't end when the guide does. Here the guided part lasts 1.5 h and, when it finishes, you can stay
    inside the basilica as long as you like and visit the Museum of the Church of the Sagrada Familia on your own. On the
    guided tours that end at the exit, that extra time doesn't exist.
- pregunta: Is it wheelchair accessible?
  respuesta: No. The operator expressly states the route is not recommended for people with reduced mobility or wheelchair
    users. If you need accessibility, the small-group guided tour in the comparison does declare it.
- pregunta: Does it include going up the towers?
  respuesta: No. Going up a tower is not part of this tour. To go up, check the «with tower» option in the comparison.
- pregunta: How long does it actually last?
  respuesta: The guided part is advertised at 1.5 h. Some travellers comment it can sometimes run slightly shorter; the good
    thing is that afterwards you have free time inside the basilica and the museum, so the total visit lasts as long as you
    want.
- pregunta: What languages is the visit in?
  respuesta: The guide works in Spanish and English. You choose the language at booking; check availability for your date.
variantes:
...
opinionEditorial: 'Its appeal is in what happens after the tour. The guided part lasts 1.5 h in a small group, but when it
  ends you aren''t walked to the exit: you stay inside the basilica and visit the Museum of the Church of the Sagrada Familia
  at your own pace. For anyone who wants the best of both worlds — to have it explained first and then soak it in quietly
  — it''s the most comfortable option. The score backs it up: 4.6 with over 1,400 reviews.


  Two honest warnings. First: it isn''t accessible — the operator says so clearly — so if you need a wheelchair, rule it out
  and look at the small-group guided tour. Second: there are reviews mentioning the guided part can sometimes run slightly
  shorter than advertised; here it matters little, because the free time afterwards makes up for it, but if you expect exactly
  90 minutes of guiding, bear it in mind. It does not include towers.

  '
categoria: visitasGuiadas
keywords:
- sagrada familia tour free time
...
- src: /images/actividades/barcelona/sagrada-familia/sagrada-familia-6622787689-hero-hero.webp
  alt: Sagrada Familia basilica facade with intricate Gothic and Modernist architectural details in Barcelona
- src: /images/actividades/barcelona/sagrada-familia/sagrada-familia-2008-18-hero-hero.webp
  alt: Sagrada Familia basilica in Barcelona with Gothic and modernist architecture, taken in 2008
...
- src: /images/actividades/barcelona/sagrada-familia/sagrada-familia-barcelona-spain-basilica-expiatory-hero-hero.webp
  alt: Sagrada Familia basilica in Barcelona with intricate Gothic spires and construction details
...
- src: /images/actividades/barcelona/sagrada-familia/pexels-36841528-hero.webp
  alt: Barcelona cityscape with modern and historic architecture under blue sky
- src: /images/actividades/barcelona/sagrada-familia/pexels-4946704-hero.webp
  alt: Barcelona street scene with modern architecture and urban landscape
...
- src: /images/actividades/barcelona/sagrada-familia/unsplash-iZCMf9MZRKI-hero.webp
  alt: Barcelona's Gothic Quarter street with medieval architecture and narrow alleyways
...
- src: /images/actividades/barcelona/sagrada-familia/unsplash-Sy4CXsj6BDE-hero.webp
  alt: Sagrada Familia basilica at sunset with golden light, Barcelona, Spain
...
- src: /images/actividades/barcelona/sagrada-familia/pexels-11920332-hero.webp
  alt: Barcelona skyline with Sagrada Familia basilica and urban architecture at sunset
---
...
- If you need accessibility: the operator does NOT recommend the route for reduced mobility. See the [small-group guided tour](/en/cities/barcelona/activities/sagrada-familia-small-group-tour).
- If you want the guided part as long as possible: here it can run slightly short. The [skip-the-line guided tour](/en/cities/barcelona/activities/sagrada-familia-skip-the-line-guided-tour) might suit you better.
...
- If you'd rather go entirely at your own pace with no guided part: the [ticket with audio guide](/en/cities/barcelona/activities/sagrada-familia-ticket-audio-guide) suits you.

To decide on timing and what to see inside, take a look at our guide [Sagrada Familia: how to visit it well](/en/guides/barcelona/sagrada-familia-how-to-visit).
