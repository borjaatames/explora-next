---
titulo: "Seville: Royal Alcázar Skip-the-Line Guided Tour (Multilingual)"
slug: "royal-alcazar-seville-skip-line-guided-tour"
ciudad: "sevilla"
descripcion: "105-minute guided tour of Seville's Royal Alcázar with official guide in Spanish, English, French or Portuguese. Skip-the-line access via express security check. 510 reviews at 4.4/5. Includes Mudéjar Palace, Gothic Palace, gardens and Cuarto Real Alto. Meeting point: Plaza del Triunfo (orange umbrella)."

slugs:
  es: "real-alcazar-sevilla-tour-guiado-skip-line"
  en: "royal-alcazar-seville-skip-line-guided-tour"

duracion: "105 minutes"
duracionMinutos: 105
precioDesde: 39
moneda: "EUR"
idiomas: ["es", "en"]
proveedor: "getyourguide"
urlReserva: "https://www.getyourguide.com/seville-l48/royal-alcazar-of-seville-skip-the-line-guided-tour-t396762/?partner_id=VPFQWBY&utm_medium=online_publisher&placement=content-middle"
...
puntoEncuentro:
  texto: "Meet your guide at the **tourist office on Plaza del Triunfo**, next to the Inmaculada Concepción monument. The guide carries a distinctive ORANGE UMBRELLA. Plaza del Triunfo is between the Cathedral, the Archivo de Indias and the Royal Alcázar — the crossroads of the 3 UNESCO sites."
...
accesibilidad: "This tour is marked «NOT suitable for people with mobility impairments» by the operator. There will be some stairs during the route. The Royal Alcázar in general has accessible areas (main entrance, palace ground floor, part of the gardens) but there are level changes and occasional steps. If you need full accessibility, consider booking general independent entry at `alcazarsevilla.org` and touring only the accessible areas at your own pace."

politicaCancelacion: "Cancellation with **60%** refund up to 24h before the start (NOT 100% refund like other products). Within 24 hours: no refunds. If you arrive late and the guide has already entered with the group, you may not be admitted (at staff discretion). The tour takes place rain or shine. Date changes subject to availability."

preguntasFrecuentes:
  - pregunta: "What's the difference vs. general independent Alcázar entry?"
    respuesta: "**General independent entry** (`alcazarsevilla.org`): €13.50, self-paced WITHOUT guide, does NOT include Cuarto Real Alto (€5.50 extra). High season queues can be 60-90 min. **This guided tour** (€39): official 105 min guide in 4 languages, skip-the-line via express control, includes Cuarto Real Alto (~€5.50 extra value). More expensive but saves 60-90 min of queue + historical/architectural context + access to Real Alto area. Recommendation: in high season (May-September, weekends, holidays), skip-the-line is worth the markup. In low season, independent entry is more efficient."
  - pregunta: "What is the Cuarto Real Alto and why does it matter?"
    respuesta: "The **Cuarto Real Alto** is the upper floor of the Palace of King Don Pedro — where the kings of Spain still stay when they visit Seville (it's the oldest royal palace still in use in Europe). Includes royal halls, bedrooms and ceremonial areas. Independently it costs €5.50 additional and the visit is PARTIAL (only 25 min). This tour INCLUDES it in the price + the guided visit covers the spaces with historical context. It's the least visited area of the Alcázar and usually has lower attendance."
  - pregunta: "How many languages are available and what's the schedule?"
    respuesta: "**Languages:** Spanish, English, French and Portuguese (4 languages with live guide). Optional audio guide in French. For German or Italian there's no direct option — consider the combo Cathedral+Giralda+Alcázar (`seville-cathedral-giralda-alcazar-guided-tour-3-5h`) which IS in Italian and other languages. **Schedules:** usually slots at 9:30, 11:00, 14:00 and 16:00, depending on language and day. Verify availability of YOUR language when booking — Spanish usually has the most slots; Portuguese the fewest."
  - pregunta: "Why does the Royal Alcázar appear in Game of Thrones?"
    respuesta: "The Royal Alcázar was the **main setting for the kingdom of Dorne** in the fifth and sixth seasons of Game of Thrones (HBO 2015-2016). The **Water Gardens of Dorne** (where the Martells and Doran Martell appear) were filmed in the Patio de las Doncellas, the Baths of María Padilla and the Alcázar Gardens. The Mudéjar Palace of Pedro I appears as the Martell palace in Sunspear. It's one of the reasons the Alcázar has seen a tourism boom since 2016 — the guide mentions these locations during the tour if you're interested in the angle."
  - pregunta: "Is the skip-the-line really worth it? Are there always queues?"
    respuesta: "The Royal Alcázar has **maximum capacity of 750 visitors/day**, which creates significant queues in high season. **July-August:** typical 60-90 min queues at general entry; skip-the-line saves those 60-90 min directly. **May-June and September:** 30-60 min queues on weekends. **October-April:** 0-30 min queues on weekdays, up to 45 min on weekends. Skip-the-line is CRITICAL in July-August. In low season, its economic value drops, but the guided tour component (105 min with official guide + Cuarto Real Alto) continues to justify the price."

variantes:
  - nombre: "Tour in Spanish"
    descripcion: "105 min with official Spanish-speaking guide. Multiple daily slots."
    precio: 39
  - nombre: "Tour in English"
    descripcion: "105 min with official English-speaking guide. Multiple daily slots."
    precio: 39
  - nombre: "Tour in French"
    descripcion: "105 min with official French-speaking guide. Optional French audio guide available."
    precio: 39
  - nombre: "Tour in Portuguese"
    descripcion: "105 min with official Portuguese-speaking guide. Limited slots — book in advance."
    precio: 39

opinionEditorial: |
  The **highest-volume guided Royal Alcázar tour on GetYourGuide** — 510 reviews at 4.4/5 make it the most established guided product to visit the oldest royal palace still in use in Europe. The 105 min tour covers the key spaces: Mudéjar Palace of Pedro I (the architectural jewel of the 14th century), Gothic Palace (the Christian part added after the Reconquest), Patio de las Doncellas with its elongated pond, Royal Chambers and Cuarto Real Alto (reserved space where the kings of Spain stay).

  **Price comparison:** €39 vs. €13.50 of independent entry. The markup (~€25-26) covers: official licensed guide 105 min + Cuarto Real Alto included (~€5.50 value) + skip-the-line via express check (worth 60-90 min in high season). The calculation comes out clearly favourable in July-August and weekends of May-September. In low season, depends on how much you value the official guide and the Cuarto Real Alto.

  **Four important operational notes:** **(1)** Cancellation policy is **60%**, not 100%. Read carefully before booking. **(2)** Marked as **not suitable for reduced mobility** by the operator — there are stairs during the tour. If you have reduced mobility but can walk, it's usually viable with calm; strict wheelchair users better opt for general independent entry and tour only accessible areas. **(3)** The Royal Alcázar has **free Mondays** in specific windows (4-5 PM Oct-Mar / 6-7 PM Apr-Sep) with advance booking on the official website — without guided tour but saves the €13.50 if your calendar allows. **(4)** The Alcázar Trust can close palace or gardens due to extreme wind or rain — the tour takes place anyway but areas may be partially closed.
...
- Visitors who can **book the free Monday slot** in advance (Mondays 4-5 PM Oct-Mar or 6-7 PM Apr-Sep at `alcazarsevilla.org`).
- Anyone seeking **German or Italian** (not available here — see Cathedral+Giralda+Alcázar 3.5h combo).
