...
accesibilidad: "LIMITED accessibility. Courtyards and most of the ground floor are level-accessible. However: (1) the main entry has 2 steps; (2) some halls have low thresholds (4-6 cm); (3) the staircase to the upper floor has NO lift; (4) gardens are level but loose gravel makes wheelchair movement harder. We recommend calling the palace beforehand (+34 954 22 52 98) to confirm accessibility for your specific visit."

politicaCancelacion: "FREE cancellation up to 24 h before start time — full refund. Within 24 h: no refunds. Ticket valid 1 day (enter at the booked time slot). Date changes subject to availability."

preguntasFrecuentes:
  - pregunta: "What is Casa de Pilatos and why visit it?"
    respuesta: "**Casa de Pilatos** is Seville's most important civil palace — built between 1483 and 1539 by the Enríquez de Ribera family and inherited by the Medinaceli house. It's the best example of SEVILLIAN architecture in transition from Gothic-Mudejar to Renaissance: combining Caliphate arches, Mudejar plasterwork, 16th-century tilework, a Flemish Gothic chapel and Italian Renaissance courtyards. It takes its name from the «Praetorium of Pilate» because the Enríquez de Ribera family made a pilgrimage to Jerusalem in 1518-1520 and built the palace replicating Pontius Pilate's house based on plans they brought back from the Holy Land. Today it's owned by the House of Medinaceli (the Dukes) and visited for its ARCHITECTURAL VALUE + Greco-Roman sculpture collection + use in international cinema."
  - pregunta: "What exactly does this ticket include?"
    respuesta: "**INCLUDED:** access to the palace's ground floor (all main courtyards, halls, gardens, chapel, Salón del Pretorio), free access to the upper floor (self-guided, no live guide), downloadable audio guide in 7+ languages. **NOT INCLUDED:** live guided tour (it's self-guided audio entry), physical headphones (it's a mobile app), access to the crypt or Medinaceli private rooms (not open to the public). If you want an official guided tour of the UPPER FLOOR (private Medinaceli apartments with furniture), it's sold SEPARATELY at the booth (~€5) subject to time slot availability."
  - pregunta: "Why isn't it free if the Medinaceli are private owners?"
    respuesta: "The Medinaceli are private owners but have opened the palace to the public since 1980 with fees that fund conservation and restoration. **Monday afternoons (3:00-5:30 PM) entry IS FREE** when you show an EU ID/passport — a family policy so residents and locals can access. The rest of the time the price is €12-13 (ground floor) — comparable to other private European palaces. The 7+ language audio guide and maintenance of 16th-century tilework justify the price."
  - pregunta: "Is it wheelchair accessible?"
    respuesta: "**LIMITED accessibility.** Main courtyards and most of the ground floor are level-accessible. However: (1) the entry has 2 steps from the street; (2) some Renaissance halls have low thresholds (4-6 cm); (3) the staircase to the upper floor has NO lift — if you're in a wheelchair, you'll miss the upper floor; (4) gardens are level but the loose gravel surface is hard on small wheels. Recommendation: call the palace at +34 954 22 52 98 BEFORE booking to confirm real accessibility for your wheelchair type. The ground floor alone justifies the visit even if you skip the upper floor."
  - pregunta: "How do I combine Casa de Pilatos with other monuments?"
    respuesta: "Casa de Pilatos is in the heart of Barrio Santa Cruz, with short distances to: (1) **Cathedral + Giralda** (`seville-cathedral-giralda-entry-ticket`) — 8 min walk SW; (2) **Royal Alcázar** (`real-alcazar-sevilla-tour-guiado-skip-line`) — 12 min walk south; (3) **Las Setas** (`seville-setas-metropol-parasol-entry-ticket-viewpoint`) — 10 min walk north; (4) **Palacio Las Dueñas** (`seville-las-duenas-palace-entry-audio-guide-app`) — 5 min walk north. Morning route: 10:00 Pilatos (1.25 h) → 11:30 Las Dueñas (1 h, more intimate House of Alba palace) → 12:45 tapas on calle Feria → 14:30 Cathedral + Giralda. Perfect «Sevillian palaces» day without overwhelm."
...
galeria:
  - src: "/images/actividades/sevilla/santa-cruz/barrio-santa-cruz-sevilla-callejon-agua-2023an002-hero.webp"
    alt: "Barrio de Santa Cruz, where Casa de Pilatos is located"
