---
titulo: "Seville: Cathedral and Giralda Skip-the-Line Entry Ticket (Audio Optional)"
slug: "seville-cathedral-giralda-entry-ticket"
ciudad: "sevilla"
descripcion: "Combined skip-the-line entry to Seville Cathedral and the Giralda tower. Optional audio guide in 5 languages (EN, ES, FR, DE, IT). Self-guided visit to the largest Gothic cathedral in the world, the tomb of Christopher Columbus and panoramic views from the top of the Giralda (35 ramps, no stairs)."

slugs:
  es: "catedral-sevilla-giralda-entrada-skip-line"
  en: "seville-cathedral-giralda-entry-ticket"

duracion: "1 day (estimated visit 75 min)"
duracionMinutos: 75
precioDesde: 15
moneda: "EUR"
idiomas: ["es", "en"]
proveedor: "getyourguide"
urlReserva: "https://www.getyourguide.com/seville-l48/seville-cathedral-and-la-giralda-entry-ticket-t131913/?partner_id=VPFQWBY&utm_medium=online_publisher&placement=content-middle"
...
politicaCancelacion: "**NON-REFUNDABLE** — this ticket does NOT allow cancellation or changes once confirmed. Verify date and time before completing purchase. If you need flexibility, consider the guided tour product (24h free cancellation) or book directly on the official Cathedral website (better terms)."

preguntasFrecuentes:
  - pregunta: "What's the difference between this ticket and the official website?"
    respuesta: "The official price on `catedraldesevilla.es` is slightly cheaper (~€14-15 general entry). On GetYourGuide you pay a small extra for: (1) multilingual management and support, (2) consolidated skip-the-line (no waiting at the ticket office queue), (3) confirmation within 48h, (4) integrated mobile audio guide option. Main advantage is convenience and multilingual support. If you have time and speak Spanish, the official website is cheaper. If you're on a tight schedule, the difference (~€3-5) is worth it for simplicity."
  - pregunta: "What exactly does the Giralda include?"
    respuesta: "The Giralda is the cathedral's bell tower, originally the minaret of the Almohad mosque (12th century), 105 metres tall. The CLIMB is via 35 wide gentle ramps — no stairs — designed for horsemen to ride up. The top offers panoramic views of Seville: Plaza del Triunfo, Alcázar, Archivo de Indias, Guadalquivir river, old town. Giralda access is INCLUDED with your Cathedral ticket (not a separate ticket). Access control is independent: even if you're already inside the Cathedral, the Giralda may have an internal queue; climb as soon as possible."
  - pregunta: "Why are Mondays free and why not always buy that way?"
    respuesta: "The Cathedral offers FREE entry on **Mondays from 2:30 to 3:30 PM** (all year) with mandatory advance booking on `catedraldesevilla.es/visita-cultural/visita-gratuita`. Limitations: (1) very narrow 1-hour window, (2) slots sell out weeks/months in advance, (3) only available on Mondays, (4) no audio guide. If you can plan well in advance and your visit falls on a Monday, it's the best option. If your calendar is flexible only by days, this GYG ticket is the next best option (skip-the-line + audio)."
  - pregunta: "How long does it take to visit Cathedral + Giralda?"
    respuesta: "**Visit estimated by the official website: 75 minutes.** Typical distribution: 30-45 min walking through the cathedral (chapels, main altarpiece, Columbus's tomb, choir, sacristy), 20-25 min climbing and descending the Giralda (including time at the top for photos), 10 min Patio de los Naranjos. If you come with audio guide and want to take advantage of all content, allow 1h 30 - 2h. If you only want the essentials: 60 min is enough."
  - pregunta: "What's the difference with the official guided tour of the Cathedral?"
    respuesta: "**This ticket (self-guided):** Entry + Giralda + optional audio guide. ~€15-19. Visit at your own pace, no physical guide. **Official guided tour** (`seville-cathedral-giralda-guided-tour-priority-access`): includes official certified guide in English or Spanish, 90 min, access to the choir and main altarpiece from the inside of the chapel (areas reserved for guided tours). Price: €20 online / €21 ticket office. If you want historical and artistic depth + access to areas closed to general public, choose the guided one. If you prefer free pace and the Giralda view without time commitment, this ticket is ideal."

variantes:
  - nombre: "Ticket Only"
    descripcion: "Cathedral + Giralda entry without audio guide. Self-guided with the information on internal panels."
    precio: 15
  - nombre: "Ticket with Audio Guide"
    descripcion: "Cathedral + Giralda entry + downloadable app audio guide (EN, ES, FR, DE, IT). You need your own headphones."
    precio: 22

opinionEditorial: |
  The **skip-the-line entry to Seville Cathedral and the Giralda** — the most used ticket for visiting the largest Gothic cathedral in the world without going through ticket office queues. The Cathedral of Santa María de la Sede, built between 1248 and 1507 on the site of the former Almohad mosque, houses the tomb of Christopher Columbus, works by Goya, Murillo and Zurbarán, and the largest altarpiece in the world. The Giralda — the 105-metre Islamic minaret converted to a Christian bell tower — is climbed via 35 wide ramps designed for horsemen to ride up, making it exceptionally accessible vs. other towers of the same period.

  **Price comparison:** from ~€15-22 (depending on option and season) versus ~€14-19 on the official website. The difference (~€3-5) covers multilingual GYG support, consolidated skip-the-line and 48h advance confirmation. If your visit is on a Monday, prioritize the **FREE official entry** (Mondays 2:30-3:30 PM with advance booking) — save money and the experience is identical.

  **Three critical points to understand before booking:** **(1)** this ticket is **NON-REFUNDABLE** — verify date and time before confirming (main limitation vs. other products with 24h cancellation). **(2)** Giralda climb is NOT wheelchair accessible (35 ramps, ~95 m accumulated). The cathedral IS accessible. **(3)** respectful attire mandatory (shoulders and knees covered; no sleeveless shirts) — if you come in light summer clothes, bring a sarong or light jacket.
...
- Anyone wanting **historical and artistic depth** (the 90-min official guided tour is clearly superior — `seville-cathedral-giralda-guided-tour-priority-access`).
- **Strict wheelchair users** wanting to climb the Giralda (not accessible; the cathedral IS).
