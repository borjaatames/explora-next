...
ciudad: "madrid"
descripcion: "Full-day guided tour (9-10 h) to Chinchón, Aranjuez (with entry to the Royal Palace) and Toledo. Round-trip bus, ES/EN guides. 4.4/5 across 158 reviews. «Likely to sell out»."
...
puntoEncuentro:
  texto: "Big Bus Madrid Welcome Centre, inside the Gran Galería Shopping Centre, Calle de San Bernardo 5, 28013 Madrid. Departure at 9:00 sharp. Metro Santo Domingo (lines 2/5) 2 minutes away."
  descripcionGuia: "Arrive 15 minutes early — the bus leaves on time and doesn't wait. It's a 10-11 hour trip (return ~19:30). Bring comfortable shoes (lots of walking) and food or money to eat out. The commentary is simultaneous bilingual (ES + EN) — the guide alternates languages."
  latitud: 40.4211
  longitud: -3.7082
  zoom: 17
...
accesibilidad: "The operator explicitly marks this as NOT suitable for wheelchair users. If you need accessibility, look at specific day trips that include it or organise the trip independently with adapted transport."
...
keywords: ["chinchon aranjuez toledo day trip", "3 cities madrid tour", "day trip from madrid", "aranjuez royal palace day trip", "toledo from madrid tour"]

imagen: "/images/actividades/madrid/toledo/01.webp"
imagenAlt: "Toledo, one of the destinations on the day trip from Madrid"

galeria:
  - src: "/images/actividades/madrid/toledo/01.webp"
    alt: "Toledo, city of the three cultures"
  - src: "/images/actividades/madrid/vista-panoramica-toledo/01.webp"
    alt: "Panoramic view of Toledo from the Mirador del Valle"
