...
idiomas: ["en"]
proveedor: "viator"
urlReserva: "https://www.viator.com/tours/Madrid/Madrid-Tapas-and-Wine-Tasting-Tour/d566-5830WINETAPAS?pid=P00298823&mcid=42383&medium=link&primaryLanguage=en"
...
puntoEncuentro:
  ...
  descripcionGuia: "Meet your guide at the bronze statue of Federico García Lorca in Plaza de Santa Ana, in front of the Teatro Español. Arrive 10 minutes early — the tour starts on time and the group walks together to the first bar."
  latitud: 40.4156
  longitud: -3.7011
  zoom: 17
...
accesibilidad: "Not wheelchair accessible. The route involves walking between several bars on cobblestone streets."

politicaCancelacion: "Cancel free up to 24 hours before the experience starts (local time) for a full refund."

preguntasFrecuentes:
  - pregunta: "Is this enough food for dinner?"
    respuesta: "Yes. The operator describes the 12+ tapas across 4 bars as enough for a full dinner. You won't need to eat afterwards."
  - pregunta: "Will the guide speak English?"
    respuesta: "Yes. The tour is run in English. The operator also lists one additional language on Viator — confirm at booking if you need a specific one."
  - pregunta: "How big is the group?"
    respuesta: "Maximum 12 people. The small-group format is part of why the tour works — you get the guide's attention and the bars don't feel invaded."
  - pregunta: "Can I bring kids?"
    respuesta: "Children under 4 are not allowed. Older kids are welcome but consider that this is a 3-hour walking tour with adult food and wine pairings."
  - pregunta: "What if it rains?"
    respuesta: "The tour runs rain or shine — you'll be inside bars most of the time. Bring an umbrella for the walks between stops."
...
opinionEditorial: |
  This is the safest pick of Madrid's tapas tours if you want one that simply works. Nearly 4,000 reviews at 4.9 stars is the kind of volume that filters out luck — the tour is consistently good. The €77 price isn't the cheapest of the bunch, but it lands you in the Barrio de las Letras (a more atmospheric setting than the Sol/Plaza Mayor circuit most operators run), with a small group of 12 max and a substantial 12-tapa dinner.
