---
titulo: Madrid Gran Vía Private Walking Tour
slug: madrid-gran-via-private-walking-tour
ciudad: madrid
descripcion: Private walking tour of Madrid's Gran Vía with a guide just for your
  group, from the Maqueta del Centenario to Plaza de Callao.
slugs:
...
- Walk along Gran Vía, from the Maqueta del Centenario to Plaza de Callao
- Beaux-Arts architecture, Art Deco skyscrapers and the historic cinemas
- Book and pay directly; price is per group, not per person
incluye:
- Live tour guide
noIncluye:
- Tips
puntoEncuentro:
  texto: Maqueta del Centenario, next to Plaza de España, 28013 Madrid
  descripcionGuia: The tour starts at the Maqueta del Centenario, at the beginning
    of Gran Vía by Plaza de España, and ends at Plaza de Callao.
  latitud: 40.4234
  longitud: -3.7122
  zoom: 16
detallesPracticos:
...
accesibilidad: Walking route accessible for wheelchairs and strollers. Moderate difficulty
  due to the distance covered.
politicaCancelacion: Free cancellation up to the start of the activity, with a full
  refund.
opinionEditorial: 'This is a very different format from large-group visits: here the
  guide is yours alone, so you set the pace and ask whatever you like. Gran Vía has
  a great story when it is told well —from an avenue conceived as a showcase of modernity
  to its cinemas and Art Deco buildings— and two hours is plenty to take it in. The
