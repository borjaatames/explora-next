...
atracciones:
  - nombre: "Prado Museum"
    descripcion: "The world's best museum of European classical painting. Velázquez, Goya, El Greco, Bosch, Rubens and Titian in the same room. Plan three to four hours and arrive at opening to dodge the groups."
    imagen: "/images/actividades/madrid/prado-edificio/museo-prado-edificio-2016-25185969599-hero.webp"
    imagenAlt: "Facade of the Prado Museum in Madrid"
  - nombre: "Royal Palace"
    descripcion: "Western Europe's largest royal palace by floor area. Throne Room, Royal Chapel and the Royal Armoury. Not the King's residence, so it's open to visitors almost daily."
    imagen: "/images/actividades/madrid/palacio-real/palacio-real-madrid-clear-day-royal-palace-tourists-hero.webp"
    imagenAlt: "Royal Palace of Madrid seen from Plaza de Oriente"
  - nombre: "Plaza Mayor"
    descripcion: "The arcaded heart of Habsburg Madrid, finished in the 17th century. Historic stage for festivals, autos de fe and markets. Today: tourist terraces (better for the photo than the meal) and the Christmas Market in December."
    imagen: "/images/actividades/madrid/plaza-mayor/plaza-mayor-madrid-casa-panaderia-felipe-iii-hero.webp"
    imagenAlt: "Madrid's Plaza Mayor with Casa de la Panadería and the equestrian statue of Felipe III"
  - nombre: "Puerta del Sol"
    descripcion: "Spain's kilometre zero for road distances. Home of New Year's Eve chimes, protests and the clock of the Casa de Correos. Central hub for metro and commuter rail."
    imagen: "/images/actividades/madrid/puerta-sol/puerta-sol-madrid-real-casa-correos-night-hero.webp"
    imagenAlt: "Night view of Puerta del Sol with the illuminated Real Casa de Correos"
  - nombre: "Gran Vía"
    descripcion: "Spain's most cinematic avenue, opened in the early 20th century. Art Deco landmarks like the Metropolis or Telefónica buildings, musical theatres, shops and life until late."
    imagen: "/images/actividades/madrid/gran-via/gran-via-madrid-metropolis-wide-view-hero.webp"
    imagenAlt: "Madrid's Gran Vía with the Metropolis Building in the background"
  - nombre: "Temple of Debod"
    descripcion: "An authentic Egyptian temple from the 2nd century BC, gifted to Spain by Egypt in thanks for help saving Abu Simbel. Priceless sunset views. Outdoor access is free; interior on specific schedule."
    imagen: "/images/actividades/madrid/debod/templo-debod-reflejo-piscina-pilonos-hero.webp"
    imagenAlt: "Temple of Debod reflected in its pool with the pylons and blue sky"
  - nombre: "Almudena Cathedral"
    descripcion: "Madrid's official cathedral, right next to the Royal Palace. An odd build: started in 1879 and consecrated only in 1993. Neo-Gothic inside, neoclassical outside."
    imagen: "/images/actividades/madrid/almudena/catedral-almudena-130826-211731-hero.webp"
    imagenAlt: "Almudena Cathedral in Madrid"
  - nombre: "Mercado de San Miguel"
    descripcion: "Early 20th-century iron-and-glass market hall. Now a tourist food hall of tapas and wines. Expensive and always packed, but worth 30 minutes for the atmosphere."
