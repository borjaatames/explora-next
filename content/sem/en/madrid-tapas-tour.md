...
meta_titulo: "Madrid tapas tours · 10 options from €59"
meta_descripcion: "Compare the 10 best Madrid tapas tours with local guides. From €59 to premium private experiences. Free cancellation 24 h before."

trust_signals:
  - texto: "Cancel 24 h before"
...
tours:
  ...
  - id: "intrepid-tapas-night"
    titulo: "Madrid Tapas Night Tour"
    descripcion: "Intrepid's evening tapas crawl in Madrid. Night-time format, classic bars in the old town. English."
    operador: "Intrepid · English · Evening"
    precio_desde: 103
    rating: 4.7
    resenas: 530
    viator_product_id: "6172MADTAPAS"
  ...
  - id: "devour-markets-tapas-gyg"
    titulo: "Madrid Ultimate Food Tour: Markets and Tapas"
    descripcion: "Devour Tours' GetYourGuide product. 6 stops with chocolate maker, Galician empanadas and Mercado Antón Martín. English."
    operador: "Devour Tours · English · 6 stops"
    precio_desde: 79
    rating: 4.8
    resenas: 182
    proveedor: "getyourguide"
    proveedor_codigo: "288825"
  ...
  - id: "secret-food-tours-gyg"
    ...
    descripcion: "Secret Food Tours GYG variant. Choose 2-hour express or 3-hour full format. Secret dish included. Bilingual guide. Cheapest option on the page."
    operador: "Secret Food Tours · Bilingual · 2h or 3h"
    precio_desde: 59
    rating: 4.9
    resenas: 147
    proveedor: "getyourguide"
  ...
  - id: "adventurous-appetites-premium"
    titulo: "Madrid Premium Tapas Tour (Small Group)"
    descripcion: "The premium option. Adventurous Appetites: 3.5 hours, group capped at 10, 12-20 tapas across 3-4 traditional bars. English. 5/5 rating."
    operador: "Adventurous Appetites · English · Max 10"
    precio_desde: 135
    rating: 5.0
    resenas: 96
    premium: true
    proveedor: "getyourguide"
    proveedor_codigo: "12804"
...
garantias:
  titulo: "Book with confidence"
  items:
    - icono: "shield"
      titulo: "Free cancellation"
      subtitulo: "Up to 24 h before the tour"
    - icono: "clock"
      titulo: "Instant confirmation"
      subtitulo: "Ticket emailed immediately"
    - icono: "mobile"
      titulo: "Mobile tickets"
      subtitulo: "Nothing to print"
    - icono: "headset"
      titulo: "Secure payment"
      subtitulo: "Via Viator and GetYourGuide"
...
faqs:
  ...
  items:
    ...
    - pregunta: "What's the small-group premium option?"
      respuesta: "Adventurous Appetites Premium. 3.5 hours, maximum 10 travellers, 12-20 tapas across 3-4 traditional bars in central Madrid. €135 per person. English-speaking guide, 5/5 rating across 96 verified reviews. This is the only English-only premium option on the page."

    - pregunta: "How do I cancel a booking?"
      respuesta: "All tours on this page have free cancellation up to 24 hours before the start time. You cancel directly from the confirmation email you receive when booking, or from your Viator / GetYourGuide account depending on the operator. Refund is full and processed in 5-10 business days."

    - pregunta: "What if it rains?"
      respuesta: "Tours run their normal route even with rain: most of the activity happens inside bars and restaurants. Only the rooftop closing stop of the World Experience tour can be affected: if the weather makes the terrace inaccessible, the operator substitutes the stop with an equivalent indoor venue. In case of severe-weather cancellation, the refund is full."

    - pregunta: "Are these tours kid-friendly?"
      respuesta: "Most accept accompanied minors. If travelling with kids, confirm with the operator at booking the alternative menu and the pace of the route."

cta_final:
  titulo: "Choose your tapas tour in Madrid"
  subtitulo: "10 verified options, free cancellation 24 h before. Book now and pay later."
  texto_boton: "See all 10 tours"

sticky_cta:
  label: "From €59"
  texto_boton: "See tours"
  etiqueta_superior: "Most booked"
---

The whole page renders from the frontmatter above. This Markdown body is intentionally empty.
